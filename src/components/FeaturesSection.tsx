...
const FeaturesSection = () => {
  ...
  const features: Feature[] = [
    ...
    },
    {
      ...
      cta: t("features.joinConversation"),
      path: "/community",
      index: "05",
      span: "lg:col-span-2",
    },
