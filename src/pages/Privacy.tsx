...
const Privacy = () => {
  return (
    ...
    <main className="container mx-auto px-4 py-8">
      ...
      <h2 className="text-2xl font-bold mb-2">What personal information do we collect from the people that visit our blog, website or app?</h2>
      <p className="mb-4">
        When ordering or registering on our site, as appropriate, you may be asked to enter your name, email address, mailing address, phone number or other details to help you with your experience.
      </p>
      <h2 className="text-2xl font-bold mb-2">When do we collect information?</h2>
      <p className="mb-4">
