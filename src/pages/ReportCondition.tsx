    ...
    navigator.geolocation.getCurrentPosition(
      ...
      (error) => {
        ...
        toast({
          ...
          description: "You can still submit the report without it.",
          variant: "destructive",
        });
      }
    );
  ...
  const handleSubmit = async () => {
    if (!user) {
      toast({
        ...
        description: "Please sign in to submit a condition report.",
        variant: "destructive",
      });
      return;
    }
    if (!monasteryId) {
      toast({ title: "Select a monastery", variant: "destructive" });
      return;
    }
    ...
    try {
      ...
      if (classifyError) {
        ...
        toast({
          ...
          description: "Saved, but AI severity classification didn't complete. An admin will review it.",
        });
        ...
        toast({ title: "Report submitted and classified" });
      }
    ...
    <PageLayout>
      <div className="container mx-auto px-4 py-12 max-w-2xl">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-foreground mb-2">Report a Condition Issue</h1>
          <p className="text-muted-foreground">
            Spotted damage, erosion, or overcrowding at a monastery? Your report helps
            Sikkim's Department of Cultural Affairs & Heritage prioritize restoration.
          </p>
        </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Reports are reviewed by an AI severity model immediately after submission.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <Textarea
                placeholder="Describe what you observed — e.g. cracked wall, water damage to murals, overcrowding near the shrine..."
                value={description}
            ...
            <div className="space-y-2">
              ...
              <Button type="button" variant="outline" onClick={captureLocation} disabled={isGettingLocation}>
                ...
                {coords ? `${coords.lat.toFixed(5)}, ${coords.lon.toFixed(5)}` : "Capture current location"}
              </Button>
            </div>
            ...
            {result && (
              <div className="rounded-lg border p-4 flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm text-muted-foreground mb-1">AI severity assessment</p>
