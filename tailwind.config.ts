  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        "gradient-button": "linear-gradient(to right, hsl(var(--nature)), hsl(var(--accent)))",
      },
      boxShadow: {
      ...
      keyframes: {
        ...
        "button-glow": {
          ...
          "50%": {
            boxShadow: "0 0 20px hsl(var(--accent) / 0.8), 0 0 30px hsl(var(--accent) / 0.6), 0 0 40px hsl(var(--accent) / 0.4)",
          },
        },
      },
      animation: {
